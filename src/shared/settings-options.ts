...
export const AUTO_LOCK_MINUTE_OPTIONS = [0, 1, 5, 10, 15, 30, 60] as const
...
export function formatAutoLockLabel(minutes: number): string {
  return minutes <= 0 ? 'Startup only' : `${minutes} min`
}
