...
import type { DesktopSyncState } from '@/desktop/sync'
...
function markSyncItemDeleted(sync: DesktopSyncState | undefined, item: ItemDetails | undefined, itemId: string, deletedAt: number) {
...
function markSyncSitePasskeyDeleted(sync: DesktopSyncState | undefined, passkey: unknown, deletedAt: number) {
  const credentialId = stringRecordField(passkey, 'credentialId')
