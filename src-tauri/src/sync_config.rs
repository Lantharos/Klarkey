...
#[tauri::command]
pub(crate) fn sync_config(app: AppHandle) -> Value {
    let mut values = read_env_files(&app);
...
fn read_env_files(app: &AppHandle) -> HashMap<String, String> {
    let mut values = HashMap::new();
    for root in env_roots(app) {
...
fn env_roots(app: &AppHandle) -> Vec<PathBuf> {
